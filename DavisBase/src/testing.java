...
public class testing {
    public static void main(String[] arg){
        ...
        ArrayList<Integer> result1 = Btree_H.search("20", -1, tablename, index_column_name);
        System.out.println("Result for less then target value: " + Arrays.toString(result1.toArray()));

        ArrayList<Integer> result2 = Btree_H.search("20", 0, tablename, index_column_name);
        System.out.println("Result for equal to target value: " + Arrays.toString(result2.toArray()));

        ArrayList<Integer> result3 = Btree_H.search("20", 1, tablename, index_column_name);
